...
function getAchievement(key: string) {
    ...
    switch (key) {
        ...
        case 'on_7':
            ...
            break;
        case 'off_15':
            result = AchievementMap.off_15;
            break;
        case 'on_15':
            result = AchievementMap.on_15;
            break;
        case 'off_30':
        ...
        case 'on_99':
            ...
            break;
        case 'off_180':
            result = AchievementMap.off_180;
            break;
        case 'on_180':
            result = AchievementMap.on_180;
            break;
        case 'off_365':
            result = AchievementMap.off_365;
            break;
        case 'on_365':
            result = AchievementMap.on_365;
            break;
        default:
            break;
    }
