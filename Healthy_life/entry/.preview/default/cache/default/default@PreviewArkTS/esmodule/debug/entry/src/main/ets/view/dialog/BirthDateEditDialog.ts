...
export class BirthdateEditDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/BirthDateEditDialog.ets(19:5)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/BirthDateEditDialog.ets(20:7)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/dialog/BirthDateEditDialog.ets(21:9)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            DatePicker.debugLine("entry/src/main/ets/view/dialog/BirthDateEditDialog.ets(29:7)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/BirthDateEditDialog.ets(41:7)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/dialog/BirthDateEditDialog.ets(42:9)");
            Text.fontSize(Const.DEFAULT_20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/dialog/BirthDateEditDialog.ets(47:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777341, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
