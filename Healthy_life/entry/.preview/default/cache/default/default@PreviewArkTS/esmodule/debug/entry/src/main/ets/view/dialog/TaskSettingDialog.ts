...
import { returnTimeStamp, createAppleRange, createDrinkRange, createSmileRange, createBrushTeethRange, createRunRange, formatTime } from "@bundle:com.example.healthy_life/entry/ets/viewmodel/TaskViewModel";
...
export class TargetSettingDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(66:5)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(67:7)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if ([taskType.getup, taskType.sleepEarly].indexOf(this.settingParams?.taskID) > Const.HAS_NO_INDEX) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TimePicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(79:9)");
            ...
            else if (this.settingParams?.taskID === taskType.smile) {
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TextPicker.create({ range: this.smileRange });
                        TextPicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(88:9)");
            ...
            else if (this.settingParams?.taskID === taskType.brushTeeth) {
                this.ifElseBranchUpdateFunction(2, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TextPicker.create({ range: this.brushTeethRange });
            ...
            else if (this.settingParams?.taskID === taskType.run) {
                this.ifElseBranchUpdateFunction(3, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        TextPicker.create({ range: this.runRange });
                        TextPicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(102:9)");
                        TextPicker.width(Const.THOUSANDTH_900);
                        TextPicker.height(Const.THOUSANDTH_800);
                        TextPicker.onChange((value: string | string[]) => {
                            this.currentValue = (value as string)?.split(' ')[0];
                ...
                this.ifElseBranchUpdateFunction(4, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TextPicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(109:9)");
                        TextPicker.width(Const.THOUSANDTH_900);
                        TextPicker.height(Const.THOUSANDTH_800);
                        TextPicker.onChange((value: string | string[]) => {
                            this.currentValue = (value as string)?.split(' ')[0];
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(117:7)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777262, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(118:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777357, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
                this.currentTime = Const.DEFAULT_TIME;
                this.currentValue = '';
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(125:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777357, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
                this.setTargetValue();
...
export class RemindTimeDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(149:5)");
            Column.justifyContent(FlexAlign.Center);
            Column.height(Const.THOUSANDTH_560);
            Column.padding(Const.DEFAULT_12);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(150:7)");
            Column.width(Const.THOUSANDTH_900);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777278, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TimePicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(159:7)");
            TimePicker.height(Const.THOUSANDTH_800);
            TimePicker.useMilitaryTime(true);
            TimePicker.onChange((value: TimePickerResult) => {
                this.currentTime = formatTime(value);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(168:7)");
            Row.justifyContent(FlexAlign.SpaceAround);
            Row.width(Const.THOUSANDTH_1000);
            Row.height(Const.DEFAULT_28);
            Row.margin({ bottom: Const.DEFAULT_20 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777265, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(175:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777357, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
...
export class FrequencyDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(216:5)");
            Column.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(217:7)");
            Column.width(Const.THOUSANDTH_900);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777279, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(218:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.margin({ top: Const.DEFAULT_10 });
            Text.width(Const.THOUSANDTH_1000);
            Text.textAlign(TextAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(226:7)");
            List.divider({
                strokeWidth: Const.DEFAULT_2,
                color: { "id": 16777359, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }
            });
            List.flexGrow(1);
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(228:11)");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(229:13)");
                            Row.width(Const.THOUSANDTH_1000);
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(230:15)");
                            Text.fontSize(Const.DEFAULT_20);
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Toggle.create({ type: ToggleType.Checkbox });
                            Toggle.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(231:15)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(250:7)");
            Row.justifyContent(FlexAlign.SpaceAround);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777262, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(251:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777357, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
                this.controller.close();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777265, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(256:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777357, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
                this.setFrequency();
