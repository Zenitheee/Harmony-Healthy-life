...
import { returnTimeStamp, createAppleRange, createDrinkRange, createSmileAndBrushRange, formatTime } from "@bundle:com.example.healthy_life/entry/ets/viewmodel/TaskViewModel";
...
export class TargetSettingDialog extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.smileAndBrushRange = createSmileAndBrushRange();
    ...
    setInitiallyProvidedValue(params: TargetSettingDialog_Params) {
        ...
        if (params.smileAndBrushRange !== undefined) {
            this.smileAndBrushRange = params.smileAndBrushRange;
        }
    ...
    private smileAndBrushRange: string[];
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(64:5)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(65:7)");
            ...
            if ([taskType.getup, taskType.sleepEarly].indexOf(this.settingParams?.taskID) > Const.HAS_NO_INDEX) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TimePicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(77:9)");
                        ...
                        TextPicker.create({
                            range: this.settingParams?.taskID === taskType.drinkWater
                                ...
                                : this.settingParams?.taskID === taskType.eatApple
                                    ? this.appleRange
                                    : this.smileAndBrushRange
                        });
                        TextPicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(86:9)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(100:7)");
...
export class RemindTimeDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(132:5)");
            Column.justifyContent(FlexAlign.Center);
            Column.height(Const.THOUSANDTH_560);
            Column.padding(Const.DEFAULT_12);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(133:7)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(134:9)");
            Text.fontSize(Const.DEFAULT_20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TimePicker.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(142:7)");
            TimePicker.height(Const.THOUSANDTH_800);
            TimePicker.useMilitaryTime(true);
            TimePicker.onChange((value: TimePickerResult) => {
                this.currentTime = formatTime(value);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(151:7)");
            Row.justifyContent(FlexAlign.SpaceAround);
            Row.width(Const.THOUSANDTH_1000);
            Row.height(Const.DEFAULT_28);
            Row.margin({ bottom: Const.DEFAULT_20 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777239, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(152:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777341, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
                this.currentTime = Const.DEFAULT_TIME;
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777242, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(158:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.fontColor({ "id": 16777341, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.onClick(() => {
...
export class FrequencyDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(199:5)");
            Column.justifyContent(FlexAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(200:7)");
            Column.width(Const.THOUSANDTH_900);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777256, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(201:9)");
            Text.fontSize(Const.DEFAULT_20);
            Text.margin({ top: Const.DEFAULT_10 });
            Text.width(Const.THOUSANDTH_1000);
            Text.textAlign(TextAlign.Start);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(209:7)");
            List.divider({
                strokeWidth: Const.DEFAULT_2,
                color: { "id": 16777343, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }
            });
            List.flexGrow(1);
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(211:11)");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(212:13)");
                            Row.width(Const.THOUSANDTH_1000);
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/view/dialog/TaskSettingDialog.ets(213:15)");
                            Text.fontSize(Const.DEFAULT_20);
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
