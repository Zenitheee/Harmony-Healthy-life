...
export class CommonConstants {
    ...
    // duration
    static readonly AD_DURATION: number = 0; // 5s
    static readonly LAUNCHER_DELAY_TIME: number = 0; // 2000ms
    ...
    static readonly RUN_TASK_NAME: string = '跑步1公里';
    ...
    static readonly RUN_RANGE: number = 100;
    // letter spacing
