...
export class WeekCalendar extends ViewPU {
    ...
    MonthViewButton(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.onClick(() => {
                // 切换到月视图
                router.pushUrl({ url: "pages/MonthCalendar" });
            });
            Button.width({ "id": 16777380, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
    ...
    initialRender() {
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new HealthText(this, { title: this.homeStore.dateTitle, fontSize: { "id": 16777355, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/home/WeekCalendarComponent.ets", line: 98 });
