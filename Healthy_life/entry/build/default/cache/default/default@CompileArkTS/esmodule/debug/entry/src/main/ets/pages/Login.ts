...
function __TextInput__inputStyle(): void {
    TextInput.placeholderColor({ "id": 16777325, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
    TextInput.height(45);
    TextInput.fontSize(18);
    TextInput.backgroundColor({ "id": 16777300, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
    TextInput.width('100%');
...
function __Line__lineStyle(): void {
    Line.width('100%');
    Line.height(2);
    Line.backgroundColor({ "id": 16777312, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
}
function __Text__blueTextStyle(): void {
    Text.fontColor({ "id": 16777315, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
    Text.fontSize(14);
...
class Login extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontSize(24);
            Text.fontWeight(FontWeight.Medium);
            Text.fontColor({ "id": 16777338, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            //登录按钮
            Button.backgroundColor({ "id": 16777316, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            //登录按钮
            ...
            if (this.isShowProgress) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.color({ "id": 16777314, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('其他登录方式');
            Text.fontColor({ "id": 16777324, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.fontSize(12);
            Text.fontWeight(FontWeight.Medium);
        ...
        this.imageButton.bind(this)({ "id": 16777473, "type": 20000, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }, this);
        this.imageButton.bind(this)({ "id": 16777474, "type": 20000, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }, this);
        this.imageButton.bind(this)({ "id": 16777475, "type": 20000, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }, this);
        Row.pop();
        // 页面纵向布局
        Column.pop();
    }
    ...
    imageButton(src: Resource, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.height(48);
            Button.width(48);
            Button.backgroundColor({ "id": 16777300, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        }, Button);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(src);
        }, Image);
